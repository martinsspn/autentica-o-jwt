"""
Django settings for autenticacao_jwt project.
...
SECRET_KEY = 'django-insecure-qczr2xr^#ppive5i53^di($*gefq64u_(%q%pu&vv4jb2(#l1('
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Para permitir requisições do Angular
]
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Para evitar problemas de CORS
]
...
ROOT_URLCONF = 'autenticacao_jwt.urls'
...
WSGI_APPLICATION = 'autenticacao_jwt.wsgi.application'
